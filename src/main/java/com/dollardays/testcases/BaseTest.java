...
//				options.addArguments("enable-logging");
				...
				// The following can be used to directly point to Chrome Driver from Your Local
				//System.setProperty("webdriver.chrome.driver", "C:\\Users\\Devaraj\\eclipse-workspace\\Team2_TaxExempt-master\\servers\\chromedriver.exe");
				
				// The following can be used to dynamically get the user directory and find the Chrome Driver from current local user
